...
{
    public class clsStaffManagemenTCollection
    {
        //private data member for the list
        List<clsStaffManagemenT> mStaffList = new List<clsStaffManagemenT>();
        //private edata member thisSt\aff
        clsStaffManagemenT mThisStaff = new clsStaffManagemenT();
        ...
        public List<clsStaffManagemenT> StaffList
        {
            get
            {
        ...
        public clsStaffManagemenT ThisStaff
        {
            get
            {
                //return the private data
        ...
        void PopulateArray(clsDataConnection DB)
        {
            ...
            mStaffList = new List<clsStaffManagemenT>();
