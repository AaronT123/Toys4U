...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 103px; top: 383px; position: absolute" Text="Apply" />
        ...
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 190px; top: 446px; position: absolute; right: 215px" Text="Edit" OnClick="btnEdit_Click1" />
        ...
        <p>
            ...
            <asp:Label ID="lblPostCode0" runat="server" style="z-index: 1; left: 116px; top: 273px; position: absolute" Text="Please Enter a Post Code"></asp:Label>
            <asp:Label ID="lblPostCode1" runat="server" style="z-index: 1; left: 116px; top: 273px; position: absolute" Text="Please Enter a Post Code"></asp:Label>
        </p>
        <p style="z-index: 1; left: 10px; top: 91px; position: absolute; height: 19px; width: 1490px">
            &nbsp;</p>
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 102px; top: 521px; position: absolute" Text="[lblError]"></asp:Label>
    </form>
</body>
</html>
